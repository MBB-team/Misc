...
returnUInt8Array(2) = uint8(hex2dec('80')); % //not sure
returnUInt8Array(3) = uint8(hex2dec('00')); % //command goes here
returnUInt8Array(4) = uint8(hex2dec('00')); % //fill up to 8 bytes
returnUInt8Array(5) = uint8(hex2dec('00')); %  
returnUInt8Array(6) = uint8(hex2dec('00')); %  
returnUInt8Array(7) = uint8(hex2dec('00')); %  
returnUInt8Array(8) = uint8(hex2dec('00')); %  
returnUInt8Array(9) = uint8(hex2dec('00')); %  
