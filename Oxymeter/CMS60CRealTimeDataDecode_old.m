...
RealTimeData.init = bitget(DataPackage(1),1:8);

%Byte 4 
RealTimeData.PulseRate         = DataPackage(4);  % bits 0-3

%Byte 5 
RealTimeData.SPO2              = DataPackage(5);  % bits 0-3
...
RealTimeArray = [  sum(RealTimeData.init)    RealTimeData.PulseRate      RealTimeData.SPO2    ];                   
%                     [1 
